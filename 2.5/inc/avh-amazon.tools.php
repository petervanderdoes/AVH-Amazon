...
switch ( $action ) {
	case 'findid' :
		avh_tools_findID ( attribute_escape ($_POST['email']), attribute_escape ($_POST['locale']), attribute_escape ($_POST['abs']) );
		break;
...
function avh_tools_getRestListSearchParams ( $email, $list = 'WishList' )
{
	...
	$itemListsearch = array ('Service' => 'AWSECommerceService', 'Operation' => 'ListSearch', 'AWSAccessKeyId' => $accesskeyid, 'Email' => $email, 'ListType' => $list, 'ResponseGroup' => 'ListInfo' );
